                      ...
                      <TableRow key={activity.id}>
                        ...
                        <TableCell sx={{ display: { xs: 'none', sm: 'table-cell' } }}>
                          <Box>
                            ...
                            <Typography variant="caption" color="text.secondary">
                              شركة: {(() => { const c = companiesData.find(x => String(x.id || x.IDCompany || x.ID) === String(activity.IDCompany)); return c ? (c.name || c.NameCompany || c.companyName || c.Name) : null; })() || activity.IDCompany || 'غير محدد'}
                            </Typography>
                          </Box>
                        </TableCell>
                        <TableCell sx={{ display: { xs: 'none', sm: 'table-cell' } }}>
